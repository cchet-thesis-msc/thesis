...
This section will discuss the implementation of the client, which uses the \mentionedtext{swagger.json} file for generating the REST-Client. Listing \vref{ls:esboi-api-client-pom} shows the dependencies, which bring in the Swagger specification and Maven Plugin, which is used to generate the REST-Client for the Client Service.
