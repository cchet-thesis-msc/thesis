...
\begin{Large}
    \begin{flushleft}
      \hspace{1cm} \makebox[3cm][c]{\includegraphics[height=8ex]{./logos/logo-fh-ooe.jpg} \vspace{1.8cm}}
    \end{flushleft}
\end{Large}
\end{minipage}
%\begin{minipage}[t]{0.5\textwidth}
...
%\begin{Large}
%    \begin{flushright}
%     \makebox[3cm][c]{\includegraphics[height=8ex]{./logos/logo-fh-ooe.jpg} \vspace{1.8cm}} \hspace{1cm}
%    \end{flushright}
%\end{Large}
%\end{minipage}
...
\begin{tabularx}{\textwidth}{lX}
 Betreuer (FH): & \ThesisSupervisor \\
 Betreuer (\ThesisExternalCompany): & \ThesisExternalSupervisor \\
...
{%
\begin{tabularx}{\textwidth}{lX}
 Supervisor (FH): & \ThesisSupervisor \\
 Supervisor (\ThesisExternalCompany): & \ThesisExternalSupervisor \\
